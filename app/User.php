...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'display_name', 'username', 'email', 'password', 'profile', 'cover', 'photo_id','photo_id_1', 'location', 'category', 'term', 'year_old', 'two_factor','contact','state','country'
    ];
